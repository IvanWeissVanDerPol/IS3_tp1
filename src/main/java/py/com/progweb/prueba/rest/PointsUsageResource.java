...
public class PointsUsageResource {
    ...
    public Response redeemPoints(@QueryParam("customerId") Integer customerId,
        ...
        try {
            PointsHeader pointsHeader = pointsService.redeemPoints(customerId, points, concept);
    ...
    @GET
    @Path("/{customerId}")
    public Response getPointsUsageByCustomer(@PathParam("customerId") Long customerId) {
        try {
